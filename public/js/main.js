...
const getInfo = async (event) => {
    ...
    if (cityVal === "") {
        ...
        try {
            ...
            let url = `http://api.openweathermap.org/data/2.5/weather?q=${cityVal}&units=metric&appid=6a2458d559ae1a36aa4ff958dbd8298e`;
            ...
            //condition to check wheather sunny or cloudy
            if (tempMood = "Clear") {
